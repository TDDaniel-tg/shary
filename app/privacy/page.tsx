      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl p-8 text-center">
            <h2 className="text-3xl font-bold mb-4">Вопросы по обработке персональных данных?</h2>
            <p className="text-blue-100 mb-6">
              Свяжитесь с нами для получения дополнительной информации или 
            ...
            <div className="mt-8 text-sm text-blue-200">
              <p>Ответственный за обработку персональных данных: Иванов Алексей Петрович</p>
              <p>Адрес: 119021, г. Москва, ул. Льва Толстого, д. 16</p>
            </div>
          </section>
        </div>
      </div>
